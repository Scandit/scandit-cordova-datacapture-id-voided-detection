...
let frameworkName = "ScanditIdVoidedDetection"
...
for candidate in [
    "framework",
    "ScanditIdVoidedDetectionPlugin-Bridging-Header.h",
    "scandit-cordova-datacapture-id-voided-detection-framework.podspec",
...
targets.insert(
    .target(
        name: "ScanditCordovaDatacaptureIdVoidedDetection",
...
let package = Package(
    ...
    products: [
        .library(
            name: "scandit-cordova-datacapture-id-voided-detection",
            targets: ["ScanditCordovaDatacaptureIdVoidedDetection"]
        )
    ],
